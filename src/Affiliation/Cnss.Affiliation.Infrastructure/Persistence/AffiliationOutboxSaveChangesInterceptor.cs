...
public sealed class AffiliationOutboxSaveChangesInterceptor : SaveChangesInterceptor
{
    ...
    private static void PersistOutboxMessages(DbContext? dbContext)
    {
        ...
        var outboxMessages = aggregateRoots
            ...
            .Select(domainEvent =>
            {
                ...
                return new AffiliationOutboxMessageRecord
                {
                    Id = Guid.NewGuid(),
        ...
        dbContext.Set<AffiliationOutboxMessageRecord>().AddRange(outboxMessages);
