...
public sealed class CotisationOutboxSaveChangesInterceptor : SaveChangesInterceptor
{
    ...
    private static void PersistOutboxMessages(DbContext? dbContext)
    {
        ...
        var outboxMessages = aggregateRoots
            ...
            .Select(domainEvent =>
            {
                ...
                return new CotisationOutboxMessageRecord
                {
                    Id = Guid.NewGuid(),
        ...
        dbContext.Set<CotisationOutboxMessageRecord>().AddRange(outboxMessages);
